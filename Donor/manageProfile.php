...
<body>
    ...
    <h1 class="centered"> Manage Profile</h1>
    </section>
    <section class="newFund-section">
        <h2 style="padding-left:20px;">Update Profile</h2>
        <div class="container">
          <form action="code2.php" name="myForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
          <?php 
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ?>
                            ...
                            <div class="col-75">
                                <input type="text" name="username" id="username" placeholder="" value="<?php echo $row['username']; ?>">
                            </div>
                            </div>
                            <div class="row">
                            <div class="col-25">
