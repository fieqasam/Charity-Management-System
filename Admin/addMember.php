...
<body>
    ...
    <section class="newFund-section">
        <h2 style="padding-left:20px;">Add New Member</h2>
        <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-75">
                <?php 
                $query_category="SELECT * FROM membercategory";
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" name="memberName" id="memberName" placeholder="Member name" required>
              </div>
            </div>
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <input type="file" name="memberImage" id="memberImage"  onchange="return fileValidation()" required>
              </div>
            </div>
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <input type="file" name="supportFile" id="supportFile"  onchange="return fileValidation()">
              </div>
            </div>
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <textarea name="addressMember" id="addressMember" style="height:50px" placeholder="address..." required></textarea>
              </div>
            </div>
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <input type="text" name="contactMember" id="contactMember" placeholder="eg:0123456789" required>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <textarea name="descriptionMember" id="descriptionMember" style="height:80px" placeholder="write comething..." required></textarea>
              </div>
            </div>
            <div class="row">
              <div class="col-25">
            ...
            <br>
            <div class="row">
              <input type="submit" name="addMemberInfo" value="Submit">
