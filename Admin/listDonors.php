...
<body>
    ...
    <section class="viewFund">
        ...
        <table id="myTable">
            ...
            <tr>
                 <?php
                        $query = "SELECT * FROM donationcharity INNER JOIN fundrisercampaignn ON donationcharity.campaignID=fundrisercampaignn.campaignID";
                        ...
                        if (mysqli_num_rows($query_run) > 0) 
                        {
                         ...
                         foreach($query_run as $row)
                         {
                           ...
                           ?>
                            ...
                            <td>
                            <a class="button buttonEdit" href="viewDonors.php?donateID=<?php echo $row['donateID']; ?>">View</a>
                            <td><a class="button buttonEdit" href="printDonation.php?donateID=<?php echo $row['donateID']; ?>">Print</a></td>
                            </td>
                        </tr>
                        <?php
                         }
